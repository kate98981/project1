...
namespace DataModels
{
	...
	/// Server Version : 12.2
	/// </summary>
	public partial class MyserviceDB : LinqToDB.Data.DataConnection
	{
		...
		public MyserviceDB(string configuration)
			: base(configuration)
		{
			InitDataContext();
			InitMappingSchema();
	...
	public partial class Request
	{
		...
		[Column("service_id"), NotNull             ] public long ServiceId { get; set; } // bigint
		...
		/// client_fk
		/// </summary>
		[Association(ThisKey="ClientId", OtherKey="Id", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="client_fk", BackReferenceName="Fks")]
		public Client Client { get; set; }

		/// <summary>
		/// service_fk
		/// </summary>
		[Association(ThisKey="ServiceId", OtherKey="Id", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="service_fk", BackReferenceName="Fks")]
	...
	public partial class Service
	{
		[Column("id"),    PrimaryKey, Identity] public long   Id    { get; set; } // bigint
		[Column("name"),  NotNull             ] public string Name  { get; set; } // text
		[Column("price"), NotNull             ] public string Price { get; set; } // text

		#region Associations

		/// <summary>
		/// service_fk_BackReference
		/// </summary>
	...
	public static partial class TableExtensions
	{
		...
		public static Request Find(this ITable<Request> table, long Id)
		{
			return table.FirstOrDefault(t =>
				t.Id == Id);
		}
